...
describe('App', () => {
  ...
  // BRANDING START: attribution link, see BrandCredit.jsx header for full removal list
  it('shows the brand credit link', () => {
    render(<App />);

    const link = screen.getByRole('link', { name: "Built for Systems Thinking Lab's Course 0" });

    expect(link).toHaveAttribute('href', 'https://systemthinkinglab.ai/course-0.html');
